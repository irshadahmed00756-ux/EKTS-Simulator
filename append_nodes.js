const fs = require('fs');
const file = 'src/nodes/CustomNodes.jsx';
let content = fs.readFileSync(file, 'utf8');

const newImports = 'import { Thermometer, Filter, ShieldAlert, ArrowDownUp, Waypoints, Activity as ActivityIcon } from \lucide-react\;';
content = content.replace('import { Zap', newImports + '\nimport { Zap');
...
export const PressureReliefNode = ({ data, isConnectable }) => {
  ...
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 80, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="P" style={{ left: '30%' }} className=\\\port \-port\\\ isConnectable={isConnectable} />
      <div style={{ position: 'absolute', bottom: -18, left: '30%', transform: 'translateX(-50%)', fontSize: '10px', color: 'var(--text-secondary)' }}>P</div>
      <Handle type="source" position={Position.Bottom} id="T" style={{ left: '70%' }} className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const PressureReducingNode = ({ data, isConnectable }) => {
  ...
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 80, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="P" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Top} id="A" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const CheckValveNode = ({ data, isConnectable }) => {
  ...
  const color = domain === 'hydraulic' ? 'var(--color-hydraulic)' : 'var(--color-pneumatic)';
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 60, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="in" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Top} id="out" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const PilotCheckNode = ({ data, isConnectable }) => {
  ...
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 60, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="in" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Top} id="out" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="target" position={Position.Left} id="X" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const ShuttleValveNode = ({ data, isConnectable }) => {
  ...
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 60, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="in1" style={{ left: '25%' }} className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="target" position={Position.Bottom} id="in2" style={{ left: '75%' }} className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Top} id="out" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const FlowMeterNode = ({ data, isConnectable }) => {
  ...
  return (
    <div className=\\\custom-node \-node\\\ style={{ borderRadius: '50%', width: 60, height: 60, padding: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', border: \\\2px solid \\\\ }}>
      <Handle type="target" position={Position.Left} id="in" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Right} id="out" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
export const FilterNode = ({ data, isConnectable }) => {
  ...
  const color = domain === 'hydraulic' ? 'var(--color-hydraulic)' : 'var(--color-pneumatic)';
  return (
    <div className=\\\custom-node \-node\\\ style={{ border: \\\1px solid \\\\, padding: 5, borderRadius: 4, width: 50, textAlign: 'center' }}>
      <Handle type="target" position={Position.Bottom} id="in" className=\\\port \-port\\\ isConnectable={isConnectable} />
      <Handle type="source" position={Position.Top} id="out" className=\\\port \-port\\\ isConnectable={isConnectable} />
...
fs.writeFileSync(file, content + newNodes);
