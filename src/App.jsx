...
const componentCategories = {
  ...
  'Hydraulics': [
    ...
    { type: 'valve', config: { subtype: '3_2' }, name: '3/2 Way Valve (Single Sol)', domain: 'hydraulic', icon: ArrowRight },
    { type: 'valve', config: { subtype: '4_2_spring' }, name: '4/2 Way Valve (Single Sol)', domain: 'hydraulic', icon: ArrowRight },
    { type: 'valve', config: { subtype: '4_2' }, name: '4/2 Way Valve (Double Sol)', domain: 'hydraulic', icon: ArrowRight },
  ...
  'Pneumatics': [
    ...
    { type: 'valve', config: { subtype: '3_2' }, name: '3/2 Way Valve (Single Sol)', domain: 'pneumatic', icon: ArrowRight },
    { type: 'valve', config: { subtype: '5_2_spring' }, name: '5/2 Way Valve (Single Sol)', domain: 'pneumatic', icon: ArrowRight },
    { type: 'valve', config: { subtype: '5_2' }, name: '5/2 Way Valve (Double Sol)', domain: 'pneumatic', icon: ArrowRight },
